...
Algebraic Spaces, Section \ref{Tag 03I3}.
Thus we may assume $S = B$.

\medskip\noindent
Assume $S = B$.
By Bootstrap, Lemma \ref{Tag 04SK}, we may assume that $B$ is affine.
...
(Remark \ref{remark-cm-base-change} and Section \ref{Tag 03I3})
